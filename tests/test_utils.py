...
def test_build_auth_url():
    ...
    assert "request_uri=urn%3Aietf%3Aparams%3Aoauth%3Arequest_uri%3Aexample" in url
...
def test_build_auth_url_with_special_chars():
    ...
    assert "client_id=client%2B123" in url
    assert (
        "request_uri=urn%3Aietf%3Aparams%3Aoauth%3Arequest_uri%3Aexample%2F123" in url
    )
